...
const string strMessageMagic = "CoExistCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    else if (pindexBest->nHeight+1 > 245000)
    {
      nSubsidy = 10 * COIN;
      return nSubsidy + nFees;
    }
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
	...
	if(pindexBest->nHeight+1 > 788400 && pindexBest->nHeight+1 < 2628000)
	nRewardCoinYear = MAX_MINT_PROOF_OF_STAKE2;
	
	else if(pindexBest->nHeight+1 >= 2628000)
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CoExistCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Thu, 11 Jun 2015 11:27:19 GMT";
        CTransaction txNew;
        txNew.nTime = 1434022039;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xcb7d32582545f4172987704187897fad8826daabb86adbd162c8ee4d2df88975"));
        block.print();
